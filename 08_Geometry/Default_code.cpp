...
bool collinearity(const pdd &p1, const pdd &p2, const pdd &p3) { return fabs(cross(p1 - p3, p2 - p3)) < eps; }
...
pdd foot(const pdd &p1, const pdd &p2, const pdd &p3) { return intersect(p1, p2, p3, p3 + perp(p2 - p1)); }
