...
\lstinputlisting{05_String/Aho-Corasick_Automatan.cpp}
...
\lstinputlisting{06_Math/ax+by=gcd.cpp}
...
\lstinputlisting{10_More/Binary_Indexed_Tree.cpp}
\subsection{Bipartite Matching.cpp}
\lstinputlisting{10_More/Bipartite_Matching.cpp}
\subsection{Closest Pair.cpp}
\lstinputlisting{10_More/Closest_Pair.cpp}
\subsection{Dijkstra.cpp}
\lstinputlisting{10_More/Dijkstra.cpp}
\subsection{Dinic.cpp}
\lstinputlisting{10_More/Dinic.cpp}
\subsection{Kosaraju.cpp}
\lstinputlisting{10_More/Kosaraju.cpp}
\subsection{Segment Tree with tag.cpp}
\lstinputlisting{10_More/Segment_Tree_with_tag.cpp}
\subsection{Suffix Array.cpp}
\lstinputlisting{10_More/Suffix_Array.cpp}
\subsection{Treap.cpp}
\lstinputlisting{10_More/Treap.cpp}
\subsection{Simple Graph Matching.cpp}
\lstinputlisting{10_More/Simple_Graph_Matching.cpp}
