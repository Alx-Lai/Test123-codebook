...
struct node {
  ...
  node(ll k = 0)
      : sum(k), mx(k), mxcnt(1), smx(-INF), mi(k), micnt(1), smi(INF),
        lazymax(-INF), lazymin(INF), lazyadd(0) {}
